...
export class role extends plugin {
	...
	async roleIndex() {
		...
		if (!data) return
		await new base(this.e).Render('roleIndex', data)
	}
	...
	async roleDetail() {
		...
		if (!data) return
		await new base(this.e).Render('roleDetail', data)
	}
	...
	async abyss() {
		...
		await new base(this.e).Render('abyss', data)
	}
	...
	async abyssFloor() {
		...
		await new base(this.e).Render('abyssFloor', data)
	}
	...
	async weapon() {
		...
		if (!data) return
		await new base(this.e).Render('weapon', data)
	}
	...
	async roleBag() {
		...
		if (!data) return
		await new base(this.e).Render('roleBag', data)
	}
	...
	async roleList() {
		...
		if (!data) return
		await new base(this.e).Render('roleList', data)
	}
	...
	async roleCard() {
		...
		if (!data) return
		await new base(this.e).Render('roleCard', data)
	}
	...
	async roleExplore() {
		...
		if (!data) return
		await new base(this.e).Render('roleExplore', data)
	}
}
